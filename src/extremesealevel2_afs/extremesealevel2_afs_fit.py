...
def get_ESL_statistics(
    ...
    print('ln20 esl data: ', esl_data)
    if esl_data == "gesla3_data":
        esl_data = "gesla3"
    print("ln23 esl_data: ", esl_data)
    ...
    if esl_data in ['gesla2','gesla3']: #from raw GESLA data
        esl_statistics = ESL_stats_from_raw_GESLA(
            ...
            preproc_settings,
            match_dist_limit,
            output_dir) #dictionary output
        print("esl stats len: ", len(esl_statistics))
